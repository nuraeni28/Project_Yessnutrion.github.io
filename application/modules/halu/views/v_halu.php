        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item active">
                ...
                <div class="slide-text slide_style_left">
                    <h1 data-animation="animated fadeInRight">Yessnutrion<span class="color-defult"> Attend </span></h1>
                <p data-animation="animated fadeInLeft" style="font-size: 20px;">For a Better Life<br>With Good Nutrition</p>
                    <a href="#" target="_blank" class="btn btn-default" data-animation="animated fadeInLeft">Sign Up</a>
            ...
            <div class="item">            
                ...
                <div class="slide-text slide_style_center">
                    <h1 data-animation="animated bounceInDown">Healthy <span class="color-defult"> News</span></h1>
                    <p data-animation="animated lightSpeedIn">Balita dan Ibu Hamil Lebih Rentan Alami<br> Masalah Gizi di Masa Pandemi COVID-19</p>
            ...
            <div class="item">            
                ...
                <div class="slide-text slide_style_right">
                    <h1 data-animation="animated fadeInLeft">Healthy <span class="color-defult"> News</span></h1>
                    <p data-animation="animated fadeInRight">Dampak Pandemi , <br>Anak Rentan Mengalami Masalah Gizi</p>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <p style="color:white; text-align: center;">Make Appointment <br> With a Nutritionist</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <p style="color:white; text-align: center;">Live Chat <br> With Nutritionist</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <p style="color:white; text-align: center;">Get Quick 24/7  <br> Help and Support</p>
            </div>
          </div>
            ...
            <div class="section-title">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <h2><span class="color-defult">Recomended</span> Nutritionist</h2>
                    ...
                    <div class="team-carousel">
                        <div class="item">
                            <div class="team-item-2">
                                ...
                                <div class="team-content">
                                    <h4><a href="#">dr. Samuel Oetoro</a></h4>
                                    <h6>Nutrition Doctor</h6>
                                ...
                                <div class="timetable">
                                    ...
                                    <a href="#" class="btn-theme text-center btn-block">CHAT</a>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="team-item-2">
                                ...
                                <div class="team-content">
                                    <h4><a href="#">Dr. Arien Himawan</a></h4>
                                    <h6>Nutrition Doctor</h6>
                                    <div class="team-content-icon">
                                        <i class="flaticon-heart"></i>
                                    </div>
                                ...
                                <div class="timetable">
                                    <div class="item">
                                        <div class="label">Monday-Friday</div>
                                        <div class="value">08:00 - 11:00</div>
                                    </div>
                                    <div class="item">
                                        <div class="label">Saturday</div>
                        ...
                        <div class="item">
                            <div class="team-item-2">
                                ...
                                <div class="team-content">
                                    <h4><a href="#">dr endang widyastuti</a></h4>
                                    <h6>Nutrition Doctor</h6>
                                    <div class="team-content-icon">
                                        <i class="flaticon-heart"></i>
                                    </div>
                                ...
                                <div class="timetable">
                                    <div class="item">
                                        <div class="label">Monday-Friday</div>
                                        <div class="value">08:00 - 15:00</div>
                                    </div>
                                    <div class="item">
                                        <div class="label">Saturday</div>
                        ...
                        <div class="item">
                            <div class="team-item-2">
                                ...
                                <div class="team-content">
                                    <h4><a href="#">dr hidayat wiriantono</a></h4>
                                    <h6>Nutrition Doctor</h6>
                                    <div class="team-content-icon">
                                        <i class="flaticon-heart"></i>
                                    </div>
                        ...
                        <div class="item">
                            <div class="team-item-2">
                                ...
                                <div class="team-content">
                                    <h4><a href="#">Dr. Dimas Herlangga</a></h4>
                                    <h6>Nutrition Doctor</h6>
                                    <div class="team-content-icon">
                                        <i class="flaticon-heart"></i>
                                    </div>
                        ...
                        <div class="item">
                            <div class="team-item-2">
                                ...
                                <div class="team-content">
                                    <h4><a href="#">dr brain gantoro</a></h4>
                                    <h6>Nutrition Doctor</h6>
                                    <div class="team-content-icon">
                                        <i class="flaticon-heart"></i>
                                    </div>
    ...
    <section class="team-area">
        <div class="container">
            <div class="section-title">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <h2><span class="color-defult">Best Seller</span> Product</h2>
                        <div class="line-border-center bg-defult"></div>
                    </div>
                </div>
            </div>
