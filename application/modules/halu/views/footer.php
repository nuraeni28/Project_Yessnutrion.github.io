...
<footer class="bg-faded">
    ...
    <script type="text/javascript" src="<?php echo base_url('js/css3-animate-it.js')?>"></script>
    <script type="text/javascript" src="<?php echo base_url('js/bootstrap-dropdownhover.min.js')?>"></script>
    <script type="text/javascript" src="<?php echo base_url('js/owl.carousel.min.js')?>"></script>
    <script type="text/javascript" src="<?php echo base_url('js/gallery.js')?>"></script>
    <script type="text/javascript" src="<?php echo base_url('js/player.min.js')?>"></script>
    <script type="text/javascript" src="<?php echo base_url('js/retina.js')?>"></script>
    <script type="text/javascript" src="<?php echo base_url('js/comming-soon.js')?>"></script>
